...
if(interactive)
    ...
    subplot(1,2,1); imagesc(real(lambda1)); axis equal image off; colormap('gray'); title('\lambda_1');
    subplot(1,2,2); imagesc(real(lambda2)); axis equal image off; colormap('gray'); title('\lambda_2');
end
